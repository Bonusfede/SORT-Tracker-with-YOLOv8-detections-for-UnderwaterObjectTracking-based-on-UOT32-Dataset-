...
imgs, fps = conv_video_in_frames('video_in/WhaleDiving.mp4')

# Otteniamo la lista di dataframe delle detections
df_list = restore_df_pickle('df_whale.pkl')
...
out = cv2.VideoWriter('video_out/out_video_test.mp4', cv2.VideoWriter_fourcc(*'mp4v'), 30,
